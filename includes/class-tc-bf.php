...
public function gf_output_partner_js() : void {
	...
	private function build_gf_price_watchdog_js() : string {
		...
		$js .= "    }\n";
		$js .= "    function getCurrencyCfg(){\n";
		$js .= "      try {\n";
		$js .= "        var cfg=null;\n";
		$js .= "        if(window.gf_global && gf_global.currency_config) cfg=gf_global.currency_config;\n";
		$js .= "        else if(window.gform && gform.i18n && gform.i18n.currency) cfg=gform.i18n.currency;\n";
		$js .= "        if(!cfg) return {};\n";
		$js .= "        return {\n";
		$js .= "          currency: String(cfg.currency||cfg.code||\"\"),\n";
		$js .= "          decimal_separator: String(cfg.decimal_separator||cfg.decimalSeparator||\"\"),\n";
		$js .= "          thousand_separator: String(cfg.thousand_separator||cfg.thousandSeparator||\"\"),\n";
		$js .= "          symbol_left: String(cfg.symbol_left||cfg.symbolLeft||\"\"),\n";
		$js .= "          symbol_right: String(cfg.symbol_right||cfg.symbolRight||\"\")\n";
		$js .= "        };\n";
		$js .= "      } catch(e){ return {}; }\n";
		$js .= "    }\n";
		...
		$js .= "      } catch(e){}\n";
		$js .= "    }\n";
		$js .= "    function installParseWrappers(){\n";
		$js .= "      try {\n";
		$js .= "        if(window.__tc_bf_gf_wrapped) return;\n";
		$js .= "        window.__tc_bf_gf_wrapped = true;\n";
		$js .= "        function wrap(name){\n";
		$js .= "          try {\n";
		$js .= "            var fn = window[name];\n";
		$js .= "            if(typeof fn !== \"function\") return;\n";
		$js .= "            if(fn && fn.__tc_bf_wrapped) return;\n";
		$js .= "            var orig = fn;\n";
		$js .= "            var wrapped = function(){\n";
		$js .= "              var args = Array.prototype.slice.call(arguments);\n";
		$js .= "              var out = orig.apply(this, args);\n";
		$js .= "              try {\n";
		$js .= "                var in0 = (args.length? args[0] : null);\n";
		$js .= "                var s = (in0==null? \"\" : String(in0));\n";
		$js .= "                var cfg = getCurrencyCfg();\n";
		$js .= "                var nIn = parseMoney(s);\n";
		$js .= "                var nOut = (typeof out === \"number\") ? out : parseMoney(out);\n";
		$js .= "                var suspicious = false;\n";
		$js .= "                if(s && (s.indexOf(\",\")!==-1 || s.indexOf(\"\\u20ac\")!==-1 || s.indexOf(\".\")!==-1)) {\n";
		$js .= "                  if(nIn!=null && nOut!=null && nIn!==0){\n";
		$js .= "                    var mult = nOut/nIn;\n";
		$js .= "                    if((mult>9.5&&mult<10.5)||(mult>95&&mult<105)) suspicious=true;\n";
		$js .= "                  }\n";
		$js .= "                  if(nOut!=null && nOut>500) suspicious=true;\n";
		$js .= "                }\n";
		$js .= "                if(suspicious && window.console){\n";
		$js .= "                  console.warn(\"[TC_BF][GF parse]\", {fn:name, in:s, inNum:nIn, out:out, outNum:nOut, currencyCfg:cfg, stack:(new Error(\"tc_bf_gf_parse\")).stack});\n";
		$js .= "                }\n";
		$js .= "              } catch(e){}\n";
		$js .= "              return out;\n";
		$js .= "            };\n";
		$js .= "            wrapped.__tc_bf_wrapped = true;\n";
		$js .= "            window[name] = wrapped;\n";
		$js .= "          } catch(e){}\n";
		$js .= "        }\n";
		$js .= "        wrap(\"gformToNumber\");\n";
		$js .= "        wrap(\"gformExtractPrice\");\n";
		$js .= "        wrap(\"gformFormatMoney\");\n";
		$js .= "        wrap(\"gformFormatNumber\");\n";
		$js .= "      } catch(e){}\n";
		$js .= "    }\n";
		$js .= "    var last={};\n";
